...
export default function PersonalClient() {
  ...
  // Estado para controlar el modal de agregar usuario
  const [modalAgregarUsuarioAbierto, setModalAgregarUsuarioAbierto] = useState<boolean>(false)

  // Obtener parámetros de la URL
  const searchParams = useSearchParams()

  // Detectar cuando el parámetro está presente y abrir el modal
  useEffect(() => {
  ...
  // Función para abrir el modal de agregar usuario desde la barra de búsqueda
  ...
  // Función para manejar éxito al crear usuario
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <BarraBusquedaPersonalizado
            ...
            onAgregarUsuario={abrirModalAgregarUsuario}
            loading={loading}
            rolFiltro={rolFiltro}
          />
        </div>
