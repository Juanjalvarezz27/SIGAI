...
import { PaginationInfo } from "../../../types/equipos"
...
export default function PaginacionSuperior({
  ...
  // Usar totalItems como fallback si totalCount es undefined
  const totalCount = pagination.totalCount || pagination.totalItems
      ...
      <div className="flex justify-between items-center">
        <div>
          <p className="text-sm text-gray-600">
            Mostrando <span className="font-semibold">{startItem}-{endItem}</span> de <span className="font-semibold">{totalCount}</span> equipos
          </p>
        </div>
