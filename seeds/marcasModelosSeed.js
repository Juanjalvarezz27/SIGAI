...
exports.default = seedMarcasModelos;
function seedMarcasModelos(prisma) {
    return __awaiter(this, void 0, void 0, function () {
        var marcas, modelos, modelosConMarcaConocida, _i, modelosConMarcaConocida_1, item, marcaDb, marcaPorDefecto, modelosConocidos_1, modelosRestantes, _a, modelosRestantes_1, nombreModelo;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma.marca.createMany({
                            data: marcas.map(function (nombreMarca) { return ({ nombre: nombreMarca }); }),
                            skipDuplicates: true,
                        })];
                case 1:
                    // Crear cada marca en la base de datos
                    ...
                    return [4 /*yield*/, prisma.marca.upsert({
                ...
                case 2:
                    ...
                    _i = 0, modelosConMarcaConocida_1 = modelosConMarcaConocida;
                    _b.label = 3;
                case 3:
                    if (!(_i < modelosConMarcaConocida_1.length)) return [3 /*break*/, 7];
                    item = modelosConMarcaConocida_1[_i];
                    return [4 /*yield*/, prisma.marca.findFirst({
                            where: { nombre: item.marca }
                        })];
                case 4:
                    marcaDb = _b.sent();
                    if (!marcaDb) return [3 /*break*/, 6];
                    return [4 /*yield*/, prisma.modelo.upsert({
                ...
                case 6:
                    _i++;
                    return [3 /*break*/, 3];
                case 7: return [4 /*yield*/, prisma.marca.findFirst({
                        where: { nombre: "POR DEFINIR" }
                    })];
                case 8:
                    marcaPorDefecto = _b.sent();
                    if (!marcaPorDefecto) return [3 /*break*/, 12];
                    modelosConocidos_1 = modelosConMarcaConocida.map(function (item) { return item.modelo; });
                    modelosRestantes = modelos.filter(function (nombreModelo) {
                        return !modelosConocidos_1.includes(nombreModelo);
                    });
                    _a = 0, modelosRestantes_1 = modelosRestantes;
                    _b.label = 9;
                case 9:
                    if (!(_a < modelosRestantes_1.length)) return [3 /*break*/, 12];
                    nombreModelo = modelosRestantes_1[_a];
                    return [4 /*yield*/, prisma.modelo.upsert({
